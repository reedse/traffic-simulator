...
import Traffic_Simulation.Interfaces.UserControlled;
import Traffic_Simulation.Decision.ChallengeResult;

//represents Truck in simulation, extends vehicle class implementing usercontrol interface
//this Truck receieves input from user and makes decisions from it
public class Truck extends Vehicle implements UserControlled {

    //constructor
    public Truck(RoadSegment currentRoad, Lane currentLane, int currentLanePos, int reputation, int dmg) {
